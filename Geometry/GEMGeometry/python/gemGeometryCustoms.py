...
def custom_GE21_v7(process) :
    ...
    process.XMLIdealGeometryESSource.geomXMLFiles.insert(mynum,'Geometry/MuonCommonData/data/v7/muonNumbering.xml')  
    ...
    geomReplace( process, 'GEMSpecs.xml','Geometry/GEMGeometryBuilder/data/v5/GEMSpecs.xml')
    return process
